...
function Header() {
    ...
    if ($[0] !== "a5e0d28c9dbe0bbeb40a9893774e0039210b6cece1333352999c85262a3bbae5") {
        for(let $i = 0; $i < 22; $i += 1){
            $[$i] = Symbol.for("react.memo_cache_sentinel");
        }
        $[0] = "a5e0d28c9dbe0bbeb40a9893774e0039210b6cece1333352999c85262a3bbae5";
    }
    let t0;
    if ($[1] === Symbol.for("react.memo_cache_sentinel")) {
        t0 = [
    ...
    const menu = t0;
    const [selection, setSelection] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])("Service");
        ...
        t1 = ({
            "Header[useEffect()]": ()=>{
                const updateLondonTime = {
                    "Header[useEffect() > updateLondonTime]": ()=>{
...
_s(Header, "Zi7uc1vNfc45i4JI9VaA4fF3GVQ=");
_c = Header;
var _c;
