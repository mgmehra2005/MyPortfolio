...
function Card(props) {
  ...
  return (
    <>
      <ScrollReveal>
        <main className="flex rounded-3xl flex-col gap-4 bg-[#161717]/60 hover:bg-[#161717] hover:border-[#3067FF] duration-600 ease-in-out p-8 border-0 border-white/10  min-w-[340px] max-w-[380px] max-h-[500px] min-h-[500px] transition-colors overflow-hidden relative">
          ...
          <Link href={link} className="">Read Article</Link>
        </main>
      </ScrollReveal>
    </>
  );
